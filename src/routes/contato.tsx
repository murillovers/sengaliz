      ...
      <section className="container-page py-24">
        ...
        <div className="mt-16 grid gap-12 md:grid-cols-2">
          <div className="space-y-6 text-sm">
            <Item icon={MapPin} t="Endereço" d="R. Sinimbu, 000 — Centro, Caxias do Sul / RS" />
            <Item icon={Phone} t="Telefone / WhatsApp" d="(54) 99999-0000" />
            ...
            />
            <a
              href="https://wa.me/5554999990000"
              className="mt-6 inline-flex items-center gap-3 bg-[color:var(--gold)] px-8 py-4 text-xs uppercase tracking-[0.28em] text-black transition-opacity hover:opacity-90"
            >
              Falar no WhatsApp
            </a>
          </div>
          <div className="aspect-[4/3] overflow-hidden bg-muted">
            <iframe
              ...
              src="https://maps.google.com/maps?q=Caxias+do+Sul+RS&t=&z=13&ie=UTF8&iwloc=&output=embed"
